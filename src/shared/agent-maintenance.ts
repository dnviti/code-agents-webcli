...
export const AGENT_MAINTENANCE_CATALOG: readonly AgentMaintenanceCatalogEntry[] = [
  { id: 'claude', label: 'Claude Code', binary: 'claude', versionArgs: ['--version'], officialSource: 'https://code.claude.com/docs/en/getting-started', channel: 'stable', channelLabel: 'Stable', platformSupport: all(), manualGuidance: 'Use the official Claude Code installer. WSL2 enables Claude Code sandboxing on Windows.' },
  { id: 'codex', label: 'Codex CLI', binary: 'codex', versionArgs: ['--version'], officialSource: 'https://github.com/openai/codex/blob/main/docs/install.md', channel: 'stable', channelLabel: 'Stable', platformSupport: [...unix(), { platform: 'win32', architectures: ['x64', 'arm64'], guidance: 'Follow the official Windows and WSL2 requirements guidance.' }], manualGuidance: 'Use the official Codex installer. On Windows, follow the official WSL2 requirements guidance.' },
  { id: 'pi', label: 'pi', binary: 'pi', versionArgs: ['--version'], officialSource: 'https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent', channel: 'stable', channelLabel: 'Stable', platformSupport: [...unix(), { platform: 'win32', architectures: ['x64', 'arm64'], guidance: 'Windows requires a Bash implementation such as Git Bash.' }], manualGuidance: 'Use the official pi installer. On Windows, install a supported Bash implementation first.', prerequisiteGuidance: 'Windows requires a Bash implementation such as Git Bash.' },
  { id: 'grok', label: 'Grok', binary: 'grok', versionArgs: ['--version'], officialSource: 'https://docs.x.ai/build/overview', channel: 'preview', channelLabel: 'Early beta', platformSupport: all(), manualGuidance: 'Grok is early beta. Use the official xAI CLI installer; Windows supports PowerShell or WSL.' },
  { id: 'qwen', label: 'Qwen Code', binary: 'qwen', versionArgs: ['--version'], officialSource: 'https://github.com/QwenLM/qwen-code', channel: 'stable', channelLabel: 'Stable', platformSupport: [{ platform: 'darwin', architectures: ['x64', 'arm64'] }, { platform: 'linux', architectures: ['x64', 'arm64'] }, { platform: 'win32', architectures: ['x64'] }], manualGuidance: 'Use the official Qwen Code installer. Windows ARM64 is unsupported.' },
